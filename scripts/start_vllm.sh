...
#
# Usage:
#   ./scripts/start_vllm.sh                         # Qwen3-4B on 1 GPU
...
# When sharing GPU with JAX training, use ~0.45 to leave room for training
# When vLLM has dedicated GPU(s), can use 0.9
